...
namespace dae
{
    void CSteamAchievements::OutputDebugString(const std::string& string)
    {
    ...
    SteamAchievement::SteamAchievement(GameObject* gameObject)
    ...
    void SteamAchievement::Notify(const Event& event, const GameObject*)
    {
        if (event.id == make_sdbm_hash("GameWon"))
        {
